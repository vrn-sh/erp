...
export const MyPhDocumentationContent = () => {
    ...
    return (
        <>
            ...
            <div>
                ...
                <p>
                    The server is an entry point for handling various routes related to MyPh shellcode operations.
                    It uses FastAPI, a modern, fast web framework for building APIs with Python. CORS is enabled for all origins.
                </p>
...
export const BasicShellcodeDocumentationContent = () => {
