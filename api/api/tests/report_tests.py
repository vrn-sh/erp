...
class ReportTestCase(TransactionTestCase):
    ...
    def create_things_to_put_in_report(self) -> None:
        ...
        self.mission_id = response.data['id']
        self.missions.append(self.mission_id)
    ...
    def test_list(self):
        ...
        self.test_academic_report(self.missions[0])
        self.test_yellow_report(self.missions[1])
    ...
    def test_update(self):
        ...
        self.test_academic_report(self.missions[0])
        report_id = self.test_yellow_report(self.missions[1])
    ...
    def test_yellow_report(self, mission_id: str = None):
    ...
    def test_nasa_report(self, mission_id: str = None):
    ...
    def test_hackmanit_report(self, mission_id: str = None):
        #if os.environ.get("TEST", False) == '1' or os.environ.get('CI', False) == '1':
        #    return
        self.create_things_to_put_in_report()
        if mission_id is None:
    ...
    def test_academic_report(self, mission_id: str = None):
        #if os.environ.get("TEST", False) == '1' or os.environ.get('CI', False) == '1':
        #    return
        self.create_things_to_put_in_report()
        if mission_id is None:
        ...
        print("test response request", response.request)
        self.assertEqual(response.status_code, 201)
        return response.data.get('id')
    ...
    def test_send_pdf_file(self):
        ...
        print(response.request, response.content)
        self.assertEqual(response.status_code, 201)
        print(response.data)