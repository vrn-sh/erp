...
class SendgridParameters:
    ...
    DEFAULT_SENDER = os.getenv(
        "DEFAULT_MAIL_SENDER", "reggi002@cougars.csusm.edu")
    SENDGRID_API_KEY = os.getenv(
        "SENDGRID_MAIL_API_KEY", "your_default_api_key")
    TEMPLATE_ID = os.getenv("TEMPLATE_MAIL_ID", "your_default_template_id")
